...
void GeometryEngine::initCubeGeometry() {
    std::array<GLfloat, 216u> vertices = {
            ...
            1.0f, -1.0f, 1.0f, 0, 0, 1, 1.0f, 0.0f, 0.0f,  // v1
            -1.0f, 1.0f, 1.0f, 0, 0, 1, 0.0f, 1.0f, 0.0f,  // v2
            1.0f, 1.0f, 1.0f, 0, 0, 1, 1.0f, 0.0f, 1.0f,   // v3

            // Vertex data for face 1
            1.0f, -1.0f, 1.0f, 1, 0, 0, 1.0f, 0.0f, 0.0f,  // v4
            1.0f, -1.0f, -1.0f, 1, 0, 0, 0.0f, 1.0f, 1.0f, // v5
            1.0f, 1.0f, 1.0f, 1, 0, 0, 0.0f, 1.0f, 0.0f,   // v6
            1.0f, 1.0f, -1.0f, 1, 0, 0, 0.0f, 0.0f, 1.0f,  // v7

            // Vertex data for face 2
            1.0f, -1.0f, -1.0f, 0, 0, -1, 1.0f, 0.0f, 0.0f,  // v8
            -1.0f, -1.0f, -1.0f, 0, 0, -1, 0.0f, 1.0f, 0.0f, // v9
            1.0f, 1.0f, -1.0f, 0, 0, -1, 0.0f, 0.0f, 1.0f,   // v10
            -1.0f, 1.0f, -1.0f, 0, 0, -1, 1.0f, .0f, 1.0f,  // v11

            // Vertex data for face 3
            -1.0f, -1.0f, -1.0f, -1, 0, 0, 0.0f, 1.0f, 0.0f, // v12
            -1.0f, -1.0f, 1.0f, -1, 0, 0, 1.0f, 0.0f, 0.0f,  // v13
            -1.0f, 1.0f, -1.0f, -1, 0, 0, 1.0f, 1.0f, 0.0f,  // v14
            -1.0f, 1.0f, 1.0f, -1, 0, 0, 0.0f, 0.0f, 1.0f,   // v15

            // Vertex data for face 4
            -1.0f, -1.0f, -1.0f, 0, -1, 0, 0.0f, 0.0f, 1.0f, // v16
            1.0f, -1.0f, -1.0f, 0, -1, 0, 0.0f, 1.0f, 0.0f,  // v17
            -1.0f, -1.0f, 1.0f, 0, -1, 0, 1.0f, 0.0f, 0.0f,  // v18
            1.0f, -1.0f, 1.0f, 0, -1, 0, 0.0f, 1.0f, 1.0f,   // v19

            // Vertex data for face 5
            -1.0f, 1.0f, 1.0f, 0, 1, 0, 1.0f, 0.0f, 0.0f,  // v20
            1.0f, 1.0f, 1.0f, 0, 1, 0, 0.0f, 1.0f, 0.0f,   // v21
            -1.0f, 1.0f, -1.0f, 0, 1, 0, 0.0f, 0.0f, 1.0f, // v22
            1.0f, 1.0f, -1.0f, 0, 1, 0, 0.0f, 1.0f, 0.0f   // v23
    };
