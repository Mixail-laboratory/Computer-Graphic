/****************************************************************************
** Meta object code from reading C++ file 'SquareWindow.hpp'
**
...
#error "The header file 'SquareWindow.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SquareWindow_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SquareWindow_t qt_meta_stringdata_SquareWindow = {
    {
QT_MOC_LITERAL(0, 0, 12) // "SquareWindow"
...
QT_INIT_METAOBJECT const QMetaObject SquareWindow::staticMetaObject = { {
    &QOpenGLWidget::staticMetaObject,
    qt_meta_stringdata_SquareWindow.data,
